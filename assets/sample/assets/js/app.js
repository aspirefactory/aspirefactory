...
const productsList = [
    {
        ...
        title: "UV Dost - Micro",
        price: "2,000",
        imageUrl: "./assets/img/portfolio/app1.jpg",
        type: "product"
    },
    {
        id: 2,
...
// WhatsApp number
const whatsappNumber = "917845802872";
    ...
    <div class="products-wrap">
      ...
      <div class="products-info">
        ...
        <div class="btn-actions mt-2">
          <a href="https://api.whatsapp.com/send?phone=${whatsappNumber}&text=Hi AspireFactory, I would like to buy this ${product.title} product." target="_blank" class="btn-enquiry">Enquiry now</a>
        </div>
      </div>
    </div>
  </div>
